...
export type GetConsecutiveTransactionQuery = {
  __typename?: 'Query'
  transactions: Array<{
    __typename?: 'TransactionsOutput'
    hash: string
 ...
 * });
 */
export function useGetConsecutiveTransactionQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetConsecutiveTransactionQuery,
    GetConsecutiveTransactionQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetConsecutiveTransactionQuery,
    GetConsecutiveTransactionQueryVariables
  >(GetConsecutiveTransactionDocument, options)
}
export function useGetConsecutiveTransactionLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetConsecutiveTransactionQuery,
    GetConsecutiveTransactionQueryVariables
  >
...
export type GetConsecutiveTransactionQueryHookResult = ReturnType<
  typeof useGetConsecutiveTransactionQuery
>
export type GetConsecutiveTransactionLazyQueryHookResult = ReturnType<
  typeof useGetConsecutiveTransactionLazyQuery
>
export type GetConsecutiveTransactionQueryResult = Apollo.QueryResult<
  GetConsecutiveTransactionQuery,
  GetConsecutiveTransactionQueryVariables
>
