...
export type Contract_Abis = {
   ...
   * This is a 64-bit signed integer.', coercing=io.stargate.graphql.schema.scalars.BigIntCoercing@7d53077e}.
   */
   ...
   * This is a variable-precision decimal.
   * Examples: "1.5", "1e-3"', coercing=io.stargate.graphql.schema.scalars.StringCoercing$5@68d27d29}.
   */
  _decimal_function?: Maybe<Scalars['Decimal']>;
  /** Invocation of an aggregate function that returns GraphQLScalarType{name='Float', description='Built-in Float', coercing=graphql.scalar.GraphqlFloatCoercing@61130b12}. */
   ...
   * This is a 32-bit IEEE-754 floating point.
   * If the value cannot be represented as a float, it will be converted. This conversion can loose precision, or range (resulting in +/-Infinity).', coercing=io.stargate.graphql.schema.scalars.FloatCoercing@77b4521d}.
   */
  _float_function?: Maybe<Scalars['Float32']>;
  /** Invocation of an aggregate function that returns GraphQLScalarType{name='Int', description='Built-in Int', coercing=graphql.scalar.GraphqlIntCoercing@3dbb6126}. */
   ...
   * This is a 16-bit signed int.
   * An error will be thrown if the value is out of bounds.', coercing=io.stargate.graphql.schema.scalars.IntCoercing$2@12b9c362}.
   */
   ...
   * .This is an 8-bit signed int.
   * An error will be thrown if the value is out of bounds.', coercing=io.stargate.graphql.schema.scalars.IntCoercing$1@69f9cf29}.
   */
   ...
   * This is an arbitrary-precision integer.
   * Examples: 1, 9223372036854775808', coercing=io.stargate.graphql.schema.scalars.VarintCoercing@e868344}.
   */
